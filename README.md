...
if(fiscal_invoice?.id) {
    ...
    if(fiscal_invoice.validation_errors.length === 0) {
        ...
        console.log(`You have ${ fiscal_invoice.validation_errors.length } validation errors`)
...
if(fiscal_invoice_with_customer?.id) {
    ...
    if(fiscal_invoice_with_customer.validation_errors.length === 0) {
        ...
        console.log(`You have ${ fiscal_invoice_with_customer.validation_errors.length } validation errors`)
...
if(credit_note?.id) {
    ...
    if(credit_note.validation_errors.length === 0) {
        ...
        console.log(`You have ${ credit_note.validation_errors.length } validation errors`)
